...
#define      DEBUG_DELAY()               Delay(0x50000)

// MPU保护参数
#define       FMC_REGION_NUMBER		         MPU_REGION_NUMBER0		      // 使用region0
#define       FMC_ADDRESS_START		         (FSMC_Addr_ILI9806G_CMD)			// 使用的首地址
#define       FMC_REGION_SIZE			         MPU_REGION_SIZE_256MB       // 使用的大小
...
#define digitalL(p,i)			{p->BSRR=(i<<16);}				//输出低电平
